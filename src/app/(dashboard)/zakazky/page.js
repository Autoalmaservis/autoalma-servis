          ...
          >
            <div className="flex items-center gap-6 w-full md:w-auto">
              ...
              <div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  {job.customer_phone && (
                    <a href={`tel:${job.customer_phone}`} onClick={e => e.stopPropagation()} className="text-zinc-400 text-[13px] font-black tracking-wider hover:text-red-500 transition-colors">📞 {job.customer_phone}</a>
                  )}
                </div>
              </div>
            </div>
            ...
            <div className="flex items-center gap-8 w-full md:w-auto justify-between md:justify-end">
              <div className="hidden sm:block text-right border-r border-zinc-800 pr-6">
                <p className="text-[11px] font-black text-red-500 uppercase tracking-widest mb-0.5">{job.job_number || `#${job.id.slice(0,8).toUpperCase()}`}</p>
